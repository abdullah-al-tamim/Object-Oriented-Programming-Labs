...
public class Main {
    ...
    public static ArrayList<Courses> object2 = new ArrayList<Courses>();
    public static ArrayList<Faculty> object3 = new ArrayList<Faculty>();
        ...
        while (true) {
            ...
            switch (n) {
                case 1:
                    ...
                    switch (cha) {
                        case 'a':
                            ...
                            Student obj = new Student(id, nam, cg);
                            object1.add(obj);
                        ...
                        case 'b':
                            ...
                            Courses obj1 = new Courses(h, o, r);
                            object2.add(obj1);
                ...
                case 4:
                    ...
                    System.out.println("d. search wheather a student takes a course");
                            ...
                            for (int i = 0; i < object2.size(); i++) {
                                for (int j = 0; j < object2.get(i).studentList.size(); j++) {
                                    if (object2.get(i).studentList.get(j).getStudentId() == n6) {
                                        System.out.println(" The student has taken these courses:");
